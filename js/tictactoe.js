...
function placeXOrO(squareNumber) {
    ...
    //to see if it contains the square numbe clicked on.
...
//This function parse the selectedsqures array to search for win conditions.
...
function arrayIncludes(squareA, squareB, squareC) {
    ...
    //true is returned and our else if condition executes the draw() function.
...
function drawWinLine (coordX1, coordY1, coordX2, coordY2) {
    ...
    let x1 = coordX1,
        ...
        x2 = coordX2,
        //This line indicates where the ned of a lines x axis is.
        y2 = coordY2,
...
function animateLineDrawing() {
    ...
    c.stroke();
    //this condition checks if we've reached th endpoints.
    if (x1 <= x2 && y1 <= y2) {
